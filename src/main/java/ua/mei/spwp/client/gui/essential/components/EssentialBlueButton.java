...
public class EssentialBlueButton extends ButtonComponent {
    public static final Identifier ACTIVE_TEXTURE = new Identifier("spwp", "essential_blue_button/active");
    public static final Identifier HOVERED_TEXTURE = new Identifier("spwp", "essential_blue_button/hovered");
    public static final Identifier DISABLED_TEXTURE = new Identifier("spwp", "essential_blue_button/disabled");

    public EssentialBlueButton(Text message, Consumer<ButtonComponent> onPress) {
